...
"icon": "▣",
"kind": "qr",
"description": "Create QR codes for URLs, text, WiFi, contact details and more. Download as SVG or PNG.",
"keywords": ["qr code generator","create qr code","qr code maker","wifi qr code","vcard qr","free qr code"],
"tips": ["Higher error correction survives damage and logos but makes the code denser. Level M suits screens; use Q or H for anything printed or stickered.","Always leave the light border — the quiet zone. Codes butted against artwork frequently fail to scan.","SVG stays sharp at any size, which matters when the same code goes on a business card and a pull-up banner.","Test the printed code with two or three different phones before committing to a print run."],
"faq": [{"q":"Do these codes expire or need an account?","a":"No. The code is generated in your browser and encodes your data directly, so it works forever and there is no redirect service that could disappear. Nothing is uploaded."},{"q":"Can I put a logo in the middle?","a":"Yes, if you use error-correction level H, which tolerates about 30% obscured area. Keep the logo under roughly a fifth of the width and re-test scanning."},{"q":"Why is my WiFi QR code not connecting?","a":"The network name and password are case-sensitive, and hidden networks need the hidden flag set. WPA3-only networks are also unreliable with older phone cameras."}]
};
})();