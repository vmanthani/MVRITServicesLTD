...
window.DEV_TOOLS["image-resizer"] = {
"title": "Image Resizer & Compressor",
"category": "developer",
"icon": "🗜️",
"kind": "image",
"description": "Resize, crop and compress images to WebP, JPEG or PNG without uploading them anywhere.",
"keywords": ["image resizer","resize image","compress image","convert to webp","reduce image size","image optimiser"],
"tips": ["WebP typically saves 25–35% over JPEG at the same visual quality, and every current browser supports it.","Quality 80 is the usual sweet spot for photographs. Above 90 the file grows fast for differences almost nobody can see.","Never serve an image larger than the space it occupies. A 4000px photo in a 800px column wastes most of what the visitor downloads.","PNG is for flat graphics and transparency. Photographs saved as PNG are typically several times larger than they need to be."],
"faq": [{"q":"Does this upload my photos?","a":"No. Everything happens on a canvas in your browser — the file is read locally, drawn, re-encoded and offered back as a download. Nothing is transmitted."},{"q":"Why did my PNG get bigger as a JPEG?","a":"JPEG is poor at flat colour and sharp edges, which is where PNG excels. For screenshots, logos and diagrams, keep PNG or use WebP."}]
};
})();